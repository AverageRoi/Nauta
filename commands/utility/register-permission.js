...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) => 
            option
                .setName("role")
                .setDescription("Role able to register coordinates.")
                .setRequired(true)
                .addChoices(
    ...
    async execute(interaction) {
        ...
        await prisma.regrole.upsert({
            ...
            update: {REGISTRATOR: interaction.options.getString("role")},
            create: {guildId: interaction.guildId, REGISTRATOR: interaction.options.getString("role")},
        })
